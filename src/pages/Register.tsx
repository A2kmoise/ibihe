    ...
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-1/2 lg:block">
        <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary/95 to-emerald-600">
          <img
            src="https://images.unsplash.com/photo-1501139083538-0139583c060f?w=1200&h=1200&fit=crop"
            alt="Hero"
        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          ...
          <div className="max-w-md">
            <h2 className="text-4xl font-black text-primary-foreground">Start Your Journey</h2>
            <p className="mt-4 text-lg text-primary-foreground/90">
              Join thousands of writers sharing their stories and building their audience on menya.
            </p>
          </div>
        </div>
      </div>
